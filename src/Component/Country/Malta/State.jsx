...
const State = () => {
  const sourceValue ="Malta"

  return (
    <div className="section">
      <div className="state-container ">
        <h1><span>Study Abroad in </span><br/>Malta</h1>
        <p>
        Get expert guidance to help you get closer to your dream of studying 
        in the Malta and fastrack your visa application process.{" "}
        </p>
