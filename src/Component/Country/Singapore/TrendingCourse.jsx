...
const TrendingCourse = () => {
  return (
    <div className="section trending-course">
      ...
      <p>Singapore offers a wide range of courses that are attractive to international students 
        due to its high educational standards and vibrant multicultural environment. Here are some 
        of the best courses to study in Singapore for international students:
      </p>
