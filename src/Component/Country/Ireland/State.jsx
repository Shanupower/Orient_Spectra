...
const State = () => {
  const sourceValue = "Ireland";
  
  return (
    <div className="section">
       <div className="state-container ">
        <h1><span>Study Abroad in </span><br/>Ireland</h1>
        <p>
        Get expert guidance to help you get closer to your dream of studying 
        in the Ireland and fastrack your visa application process.{" "}
        </p>
      ...
      <div className="GDP-container">
        ...
        <div className="International-conatiner">
          <p>Indian Students in Ireland</p>
          <h1>7,000</h1>
        </div>
      </div>
    </div>
