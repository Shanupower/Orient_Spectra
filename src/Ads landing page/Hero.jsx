  ...
  return (
    <div className="Leadgeneration-container section">
      <div className="Leadgeneration-content section">
        ...
        <p>
          Study abroad in UK by applying for either November 2024 or January
          2025 intakes. Apply now to get early bird scholarships. Attend the
          event to get personal one-on-one interaction with UK university
          delegates, and get all your doubts cleared.
        </p>
