...
export const HeroPagedata = [
  ...
  {
    id: 3,
    text: "Rise of new education",
    heading: "Superpowers as Big 4",
    bgImage: Img2,
    subtext: "– US, UK, Australia and Canada – face headwinds",
  },
  {
    id: 4,
    text: "Reasons to Study in Germany",
    heading: "– Data Science course",
    bgImage: Img3,
    subtext:
      "Experienced sustained double-digit growth over a number of years, only to find that their supply chain struggled to keep pace.",
  },
];
